(ns architecture.actor
  "ArchitectureActor — the ISCO-08 2161 independent building architect actor as
  ...
  The unconditional invariant: the ArchitectureAdvisor can never
  directly issue a stamped design, certify code compliance, or dispatch
  a robot action the ArchitectureGovernor refuses — every
...
(defn build-graph
  "Build a compiled ArchitectureActor graph. `store` implements
